...
to startup
  ...
  set speed 0.4
  set contact-radius 1.0
  set infection-prob 0.25
  set recovery-time 60
  set wrap? true
end
...
to recover-some
  ask people with [ state = "I" and time-infected >= recovery-time ] [
    set state "R"
    recolor
  ]
end
...
"" ""
PENS
"S" 1 0 -955883 true "plot count people with [state = \"S\"]" "plot count people with [state = \"S\"]"
"I" 1 0 -2674135 true "plot count people with [state = \"I\"]" "plot count people with [state = \"I\"]"
"R" 1 0 -10045621 true "plot count people with [state = \"R\"]" "plot count people with [state = \"R\"]"
@#$#@#$#@
## WHAT IS IT?
